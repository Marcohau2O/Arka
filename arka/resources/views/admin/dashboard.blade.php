  ...
  <nav>
    ...
    <div class="card-container">
        ...
        <div class="card">
            ...
            <p>
                <button onclick="window.location.href='/admin/productosEs'" class="button type1">
                    <span class="btn-txt">Más Información</span>
                </button>
            </p>
        </div>
        <div class="card">
            ...
            <p class="card-body">
                Esto es para editar todo los productos Medicinales.
            </p>
            <p>
                <button onclick="window.location.href='/admin/productosMe'" class="button type1">
                    <span class="btn-txt">Más Información</span>
                </button>
            </p>        
            </div>
